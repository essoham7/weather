...
import { ImageBackground, ScrollView, StatusBar, StyleSheet, Text, useWindowDimensions, View, Animated, TouchableOpacity } from 'react-native';
                           ...
                           <View style={styles.bottomInfoWrapper}>
                              <View style={{alignItems: 'center'}}>
                                ...
                                <View style={styles.infoBar}>
                                  <View style={{width: location.wind /2, height: 5,
                              ...
                              <View style={{alignItems: 'center'}}>
                                ...
                                <Text style={styles.infoText}>%</Text>
                                <View style={styles.infoBar}>
                                  <View style={{width: location.rain /2,
                                                 height: 5,
                                                 backgroundColor:'#F44336'}} />
                                </View>
                              </View>
